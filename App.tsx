      ...
      <header className="bg-slate-900/50 backdrop-blur-md border-b border-slate-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Developer Info & YouTube */}
            <div className="flex items-center gap-3 mr-2 border-r border-slate-700 pr-4">
              <span className="text-xs text-slate-400 hidden md:inline">Dev by <span className="text-slate-200 font-semibold">GPT PARK</span></span>
              <a 
                href="https://www.youtube.com/@AIFACT-GPTPARK" 
                target="_blank" 
                rel="noreferrer"
                className="text-red-500 hover:text-red-400 transition-colors text-xl flex items-center"
                title="GPT PARK YouTube Channel"
              >
