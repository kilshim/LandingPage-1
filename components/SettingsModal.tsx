      ...
      <div className="bg-slate-900 rounded-2xl border border-slate-700 w-full max-w-lg shadow-2xl overflow-hidden transform transition-all scale-100">
        ...
        <div className="bg-slate-800 px-6 py-4 border-b border-slate-700 flex justify-between items-center">
          <h3 className="text-xl font-bold text-white flex items-center gap-2">
            <i className="fas fa-sliders-h text-blue-400"></i> API 키 설정
          </h3>
        ...
        <div className="p-6 space-y-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
             ...
             <div>
                ...
                <div className="flex gap-2 mb-1">
                  <input
                    ...
                    className="flex-1 px-4 py-2 rounded-lg bg-slate-950 border border-slate-700 text-white focus:ring-2 focus:ring-purple-500 outline-none placeholder-slate-600"
                  />
                  {config.geminiApiKey && (
                      <button 
                        onClick={handleClearGeminiKey}
                        className="px-3 py-2 rounded-lg text-sm font-medium border bg-red-900/30 border-red-500 text-red-400 hover:bg-red-900/50 transition-colors"
                        title="키 삭제"
                      >
          ...
          {/* 2. Image Provider Config */}
          <div className="space-y-3">
             <div className="flex justify-between items-center border-b border-slate-700 pb-2 mb-4">
                 <h4 className="text-md font-semibold text-white flex items-center gap-2">
                     <i className="fas fa-images text-emerald-400"></i> 이미지 소스 설정
                 </h4>
             </div>
             ...
             <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2 rounded-lg bg-slate-950 border border-slate-700 text-white focus:ring-2 focus:ring-emerald-500 outline-none"
                >
             ...
             <div className="pt-2 space-y-6">
                ...
                {config.preferredProvider === 'loremflickr' && (
                    <div className="text-center py-4 text-slate-400 text-sm bg-slate-800/50 rounded-lg">
                ...
                <div className={`transition-opacity duration-200 ${config.preferredProvider === 'unsplash' ? 'opacity-100' : 'hidden'}`}>
                  ...
                  <div className="flex gap-2 mb-1">
                    <input
                      ...
                      className="flex-1 px-4 py-2 rounded-lg bg-slate-950 border border-slate-700 text-white focus:ring-2 focus:ring-emerald-500 outline-none placeholder-slate-600"
                    />
                    <button 
                  ...
                  <div className="text-xs text-slate-500 flex justify-between items-center px-1">
                    ...
                    <a href="https://unsplash.com/oauth/applications" target="_blank" rel="noreferrer" className="text-emerald-400 hover:text-emerald-300 underline decoration-emerald-400/30">
                ...
                <div className={`transition-opacity duration-200 ${config.preferredProvider === 'pexels' ? 'opacity-100' : 'hidden'}`}>
                  ...
                  <div className="text-xs text-slate-500 flex justify-between items-center px-1">
                    ...
                    <a href="https://www.pexels.com/api/new/" target="_blank" rel="noreferrer" className="text-emerald-400 hover:text-emerald-300 underline decoration-emerald-400/30">
                       키 발급 페이지로 이동 <i className="fas fa-external-link-alt ml-1"></i>
                    </a>
                  </div>
                </div>
                ...
                <div className={`transition-opacity duration-200 ${config.preferredProvider === 'pixabay' ? 'opacity-100' : 'hidden'}`}>
                  ...
                  <div className="text-xs text-slate-500 flex justify-between items-center px-1">
                    ...
                    <a href="https://pixabay.com/api/docs/" target="_blank" rel="noreferrer" className="text-emerald-400 hover:text-emerald-300 underline decoration-emerald-400/30">
                       키 발급 페이지로 이동 <i className="fas fa-external-link-alt ml-1"></i>
                    </a>
                  </div>
                </div>
